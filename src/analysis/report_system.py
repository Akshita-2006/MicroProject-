...
Validation: the latest full suite has 20 passing tests, including station-screening, interval-end preprocessing, recent station-name-link and recent-weather checks. Streamlit AppTest passed after the station-coverage audit was added. New pollutant preprocessing is not yet integrated into the dashboard or trained models. See [validation record](validation.md) and [acceptance evidence](../docs/acceptance.md).
...
'''
    ...
    text = title + '\n\n' + status.replace('# Project status — 18 September 2026', '## Current completion status — 18 September 2026', 1) + '\n\n---\n' + body
