...
| Pollutants | Recorded 2024-2025 concentrations; plain-language pollutant effects and green/yellow/red station-relative comparison; 2025 1/6/12/24-hour concentration forecasts, held-out accuracy, and optional non-diagnostic precaution profile |
...
Recorded 2024-2025 concentrations are displayed separately from the historical AQI forecast. Their colours compare a reading to the same station's 2025 records: green is lower than the median, yellow is from the median to the 90th percentile, and red is at or above the 90th percentile. These colours are not health limits. The 2025 concentration forecasts were trained on 2017-2023, checked on 2024 and tested once on 2025. R² is labelled as a model-quality score, not a pollution percentage or medical score. The dashboard is not a live service.
